import 'package:firebase/profile_data.dart';
import 'package:firebase/social_auth.dart';
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: const FirebaseOptions(
            apiKey: "AIzaSyDJzBxJIVHLsdP26H0mpkxuTAGtE-y_wK0",
            authDomain: "fir-demo-cc782.firebaseapp.com",
            projectId: "fir-demo-cc782",
            storageBucket: "fir-demo-cc782.appspot.com",
            messagingSenderId: "163796426516",
            appId: "1:163796426516:web:a5dd320c26a429add9ac01"));
  } else {
    await Firebase.initializeApp();
  }
  runApp(const MyApp());
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => MyHomePage(),
        '/second': (context) => const UserProfile(),
        '/third': (context) => const GoogleAuth(),
        '/fourth': (context) => const ProfileData(),
      },
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
            ...
            child: const Icon(Icons.add_circle, color: Colors.amber)),
        title: const Text(
          'FireBase Demo',
          style: TextStyle(
              ...
              children: [
                Form(
                  ...
                  child: TextFormField(
                    autofocus: true,
                    onFieldSubmitted: (value) {
                      FocusScope.of(context).requestFocus(_focusNodeEmailLink);
                    },
                    validator: (String? value) {
                      if (value!.isEmpty) {
    ...
    return await widget._auth
        .sendSignInLinkToEmail(
          ...
          actionCodeSettings: ActionCodeSettings(
            ...
            //    androidPackageName: 'https:/com.example.firebase',
